...
- Internal links are relative Markdown links to the `.md` file, e.g. `[Style guide](Style-Guide)`; links into the project docs go up to the repo root with a heading anchor.
...
- [AI-Managed Wiki](AI-Managed-Wiki) — how Claude Code maintains this wiki
- [Protocol 1: Harmonize](Protocol-1-Harmonize) — harmonization protocol that checks for style violations

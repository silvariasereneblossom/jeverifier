...
- Internal links are relative Markdown links to the `.md` file, e.g. `[Style guide](../meta/style-guide.md)`; links into the project docs go up to the repo root with a heading anchor.
...
- [AI-Managed Wiki](ai-managed-wiki.md) — how Claude Code maintains this wiki
- [Protocol 1: Harmonize](../protocols/1-harmonize.md) — harmonization protocol that checks for style violations
